...
#define FP_INT				FP_EN			//interrupt state	
#define LED_CTRL			LED_ON			//LED control mode
#define LED_SPD				255				//LED speed
#define LED_COLOR			LED_PURPLE		//LED color
...
uint8 FP_readFinger(void);							//reads finger and returns the id of the matched template in the sensor library
